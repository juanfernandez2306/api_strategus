...
class ExportExcelService
{
    ...
    public function generateMonitoreosExcel(string $fechaInicioParam, string $fechaFinParam)
    {
        ...
        // 2. Inicializar la hoja de cálculo de PhpSpreadsheet
        ...
        // 3. Volcar datos obtenidos si el rango contiene registros
        if (!empty($data)) {
        ...
        // 4. Preparar la salida binaria en memoria (php://temp)
